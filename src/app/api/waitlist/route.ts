        ...
        <div style="padding: 40px;">
          ...
          ">
            ...
            <p style="
              ...
              line-height: 1.5;
              margin: 0;
            ">La próxima vez que vayas a preguntarle algo a una IA, para un momento. Inténtalo tú primero. Aunque sea durante 30 segundos. Aunque tu respuesta no sea perfecta.</p>
          </div>
          ...
          <p style="
            ...
            line-height: 1.7;
            margin: 0 0 32px;
          ">Ese esfuerzo es exactamente lo que noüs va a entrenar.</p>
...
export async function POST(request: NextRequest) {
  try {
    ...
    await resend.emails.send(welcomeEmail(normalizedEmail))
